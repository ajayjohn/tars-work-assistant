# Getting Started (Internal Quick Reference)

> **User-facing guide**: See `/GETTING-STARTED.md` in the repository root for the comprehensive getting started guide with habit-building and maturity progression.

This document is an internal quick reference for skill developers.

---

# Getting started (internal) with TARS

...
- Update [README.md](README.md) and [ARCHITECTURE.md](ARCHITECTURE.md) if the public surface changed
...
- Update [ARCHITECTURE.md](ARCHITECTURE.md) if folder structure or note types changed
...
- Update [BUILD.md](BUILD.md) or [reference/shortcuts.md](reference/shortcuts.md) when packaging or scheduled behavior changes
- Update [CHANGELOG.md](CHANGELOG.md)
...
- Update [GETTING-STARTED.md](GETTING-STARTED.md) if onboarding expectations changed
- Run `python3 tests/validate-docs.py`

...
help:
  purpose: |
    Draft and refine stakeholder communications with empathy audit, RASCI enforcement, and tone adaptation. Optimizes for clarity, alignment, and psychological safety while adapting tone and format to audience (upstream executives, downstream teams, external partners).
  use_cases:
    - "When you need to draft an email or message to a stakeholder"
    - "When you want to refine a message for clarity and tone"
    - "When you need to ensure RASCI roles and deadlines are explicit"
  invoke_examples:
    - natural: "draft an email to X about Y"
    - natural: "refine this message"
    - natural: "help me communicate with the board"
    - slash: "/communicate"
  common_questions:
    - q: "What's the difference between upstream and downstream modes?"
      a: "Upstream (board, CEO) uses BLUF and strategic framing. Downstream (team) is context-rich and motivating with clear RASCI."
    - q: "What's RASCI enforcement?"
      a: "Every task in the communication must have explicit WHO (Responsible), WHO (Accountable), and WHEN (specific date)."
  related_skills: [think, create, learn]
---

...
help:
  purpose: |
    Five complementary strategic thinking modes for complex decisions and ambiguous problems. Strategic analysis applies Tree of Thoughts with mandatory framework selection. Validation council stress-tests plans with CFO, CTO, Competitor, and Customer personas. Executive council simulates CPO/CTO debate on organizational decisions. Deep analysis chains all three sequentially. Discovery mode enforces understanding and gap identification before proposing solutions.
  use_cases:
    - "When user wants deep analysis of a strategy or decision"
    - "When user says 'analyze this' or 'help me think'"
    - "When user wants to stress-test a plan: 'what could go wrong'"
    - "When user needs conflict resolution or strategic debate: 'council', 'council debate'"
    - "When user wants to understand a problem before solving: 'discovery mode'"
    - "When user wants a complete analysis chain: 'deep dive'"
  invoke_examples:
    - natural: "Analyze this strategy"
    - natural: "Stress test this plan"
    - natural: "Let's do a council debate"
    - natural: "Deep dive on this problem"
    - natural: "Discovery mode—help me understand before we solve"
    - slash: "/think analyze"
    - slash: "/think stress-test"
    - slash: "/think debate"
    - slash: "/think deep"
    - slash: "/think discover"
  common_questions:
    - q: "What's the difference between validation council and executive council?"
      a: "Validation council stress-tests a plan with adversarial personas (CFO, CTO, Competitor, Customer) looking for fatal flaws. Executive council debates organizational strategy between CPO and CTO personas with internal context."
    - q: "When should I use discovery mode?"
      a: "When the problem is ambiguous or you're unsure what to solve. Discovery mode maps context, identifies gaps, and asks probing questions WITHOUT proposing solutions."
    - q: "What framework selection means?"
      a: "Before analysis, you must pick 1-2 frameworks (Working Backwards, Pre-Mortem, etc.) and state why. This ensures rigorous thinking, not just intuition."
  related_skills: [initiative, create, communicate]
---

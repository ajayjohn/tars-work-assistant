...
help:
  purpose: |
    Generate presentation-grade content including decks, narratives, speeches, and thought leadership pieces. Loads context from memory and adapts format, tone, and messaging for upstream (board, executives), downstream (teams), or external (conference, partners) audiences.
  use_cases:
    - "When you need to create a presentation deck for a specific audience"
    - "When you want to write a speech or narrative for a meeting or event"
    - "When you need thought leadership content for external audiences"
  invoke_examples:
    - natural: "create a deck about X"
    - natural: "write a speech for the board"
    - natural: "generate a narrative about Y"
    - slash: "/create"
  common_questions:
    - q: "What formats do you support?"
      a: "Decks (slide-by-slide), Narratives (long-form), and Speeches (with speaker notes and timing)."
    - q: "How do you adapt for different audiences?"
      a: "Board/upstream gets BLUF and strategic ROI focus. Teams get context-rich and motivating. External gets thought leadership framing."
  related_skills: [communicate, think, initiative]
---

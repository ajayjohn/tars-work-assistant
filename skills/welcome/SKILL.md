...
help:
  purpose: |
    First-time setup wizard for TARS. Creates workspace directory structure, verifies integrations, and gathers your identity, organization, teams, and people context through progressive onboarding steps.
  use_cases:
    - "When setting up TARS for the first time in a new workspace"
    - "When you want to create all required directories and templates"
    - "When you need to verify your integrations are working correctly"
  invoke_examples:
    - natural: "set up TARS"
    - natural: "first time setup"
    - slash: "/welcome"
  common_questions:
    - q: "Can I add more people and context after initial setup?"
      a: "Yes. Setup creates the initial structure and key entities. You can always add more to memory as you use TARS."
    - q: "What if I already have a TARS workspace?"
      a: "Welcome will detect your existing workspace and offer to add to it, start fresh, or cancel."
  related_skills: [maintain, briefing, core]
---
